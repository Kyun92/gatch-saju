...
올해의 종합 운세와 12개월 월별 운세를 작성해주세요.

[포함 항목]
1. 올해의 종합 운세 요약 (300-500자)
   - 대운+세운이 원국에 미치는 영향
   - 올해의 핵심 키워드 3개
   - 올해의 전체적인 흐름과 방향성

2. 영역별 올해 운세 (각 200-300자)
   - 직업/사업운
   - 재물/금전운
   - 연애/인간관계
   - 건강/컨디션

3. 12개월 월별 운세 (각 100-150자)
   - 각 월의 월운 간지가 원국+세운과 어떻게 교차하는지
   - 그 달의 핵심 조언 1줄
   - 주의할 점 또는 기회
...
[형식] 반드시 순수 텍스트(plain text)로만 출력. 마크다운 문법 절대 금지. 이모지 가능. 단락은 빈 줄로 구분.
[분량] 총 2500-4000자`;
