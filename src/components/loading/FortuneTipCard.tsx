...
const GENERAL_TIPS: Tip[] = [
  {
    kind: "saju",
    label: "사주 8글자",
    body: "사주 8글자 중 가장 중요한 건 단 1글자, '일간'. 태어난 날의 하늘 기운이 곧 나의 본성이에요.",
  },
  {
    kind: "saju",
    label: "오행의 순환",
    body: "나무→불→흙→쇠→물. 이 다섯 기운이 막힘없이 흘러야 운이 잘 풀린다고 봐요.",
  },
  {
    kind: "ziwei",
    label: "자미두수의 기원",
    body: "북송 시대 도사가 창시한 별 기반 운명학. 14개 주성이 12궁을 돌며 내 인생 지도를 그려요.",
  },
  {
    kind: "ziwei",
    label: "명궁과 신궁",
