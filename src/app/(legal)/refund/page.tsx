...
export const metadata: Metadata = {
  title: "환불정책 | 갓챠사주",
  description: "갓챠사주 코인 환불 기준 및 절차 안내",
...
export default function RefundPage() {
  return (
    <div className="legal-doc">
      ...
      <section className="legal-section">
        <h2 className="legal-h2">1. 코인 결제 구조 개요</h2>
        <p>
          갓챠사주는 이용자가 패키지 단위로 코인을 충전하고, 보유 코인으로 유료
      ...
      <section className="legal-section">
        ...
        <ol className="legal-ol">
          <li><strong>결제일 기준 7일 이내의 미사용 코인</strong>: 결제일로부터 7일 이내에 요청하시면, 해당 결제에서 아직 사용되지 않은 코인에 한해 전액 환불됩니다.</li>
          <li><strong>서비스 오류로 콘텐츠가 정상 제공되지 않은 경우</strong>: 회사의 귀책으로 감정 결과가 생성되지 않았거나, 열람 불가능한 상태로 제공된 경우 해당 감정에 사용된 코인을 복구하거나 그에 상응하는 금액을 환불합니다.</li>
      ...
      <section className="legal-section">
        ...
        <ol className="legal-ol mt-2">
          <li><strong>이미 사용된 코인</strong> — 감정 생성에 사용된 코인은 해당 콘텐츠가 제공된 것으로 보아 환불이 제한됩니다 (동법 제17조 제2항 제5호: 용역 또는 재화의 제공이 개시된 디지털 콘텐츠).</li>
          <li><strong>결제일로부터 7일이 경과한 코인</strong> — 서비스 오류로 인한 경우는 예외.</li>
          <li>이용자의 귀책사유로 회사가 환불을 이행할 수 없는 경우.</li>
        </ol>
        <div className="legal-callout mt-3">
          한 번 사용된 코인으로 생성된 감정 결과물은 반복 열람과 복제가 가능하므로,
          <strong> 사용된 코인에 대한 단순 변심 환불은 제한</strong>됩니다. 충전 전 상품과 가격을
          충분히 확인해 주시기 바랍니다.
        </div>
      </section>

      <section className="legal-section">
        <h2 className="legal-h2">4. 코인의 유효기간</h2>
        <p>
          충전한 코인에는 <strong>유효기간이 없습니다</strong>. 회원 상태가 유지되는 한
          언제든지 사용하실 수 있습니다. 단, 회원 탈퇴 시 보유 코인은 모두 소멸되며
          환불 대상에서 제외됩니다.
        </p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>
          하나의 결제 건에서 일부 코인이 이미 사용된 경우, <strong>사용되지 않은 나머지
          코인에 한해 부분 환불</strong>이 가능합니다. 환불 금액은 다음과 같이 계산됩니다.
        </p>
        <div className="legal-callout mt-2">
          환불 금액 = 결제 금액 × (남은 코인 수 / 구매한 코인 수)
          <br />
          예) 5코인 4,200원 패키지 구매 후 2코인 사용 → 남은 3코인 환불,
          환불 금액 4,200 × 3/5 = 2,520원
        </div>
      </section>
